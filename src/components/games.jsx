...
const Games = () => {
    ...
    const addGame = async () => {
        ...
        if(title === '' || genre === ''||releaseDate === ''||price === ''||image === ''||platform === ''){
    ...
    return (
        <>
            ...
            <div className="">
                ...
                <input type="text" placeholder="release_date" onChange={(e)=>{setReleaseDate(e.target.value)}}/>
                <input type="text" placeholder="price" onChange={(e)=>{setPrice(e.target.value)}} />
                <input type="text" placeholder="image_path" onChange={(e)=>{setImage(e.target.value)}} />
                <input type="text" placeholder="platform" onChange={(e)=>{setPlatform(e.target.value)}} />
